...
HTTPS プロキシを経由している場合もダウンロードに失敗することがあるようです。可能であれば一旦 HTTPS プロキシを無効化してから再度お試しください。
...
**⚠️ 企業内ネットワークや HTTPS プロキシ経由などの特殊なインターネット環境では、初回起動時にデフォルトモデルのダウンロードに失敗し、起動できない場合があります。** その場合は以下をお試しください。
